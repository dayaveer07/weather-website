...
function forecast(long,lat,callback){
 ...
 callback(undefined,`${body.daily.data[0].summary} The temperature is ${body.currently.temperature}  and there are ${body.currently.precipProbability } % chances of rain`)
}
})
}
